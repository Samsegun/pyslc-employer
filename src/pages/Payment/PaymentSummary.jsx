...
const PaymentSummary = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <div
                    className='flex px-3 py-1 rounded cursor-pointer'
                    style={{
                        color: "white",
                        background: "#1C6AF4",
                        width: "100px",
    ...
    return (
        <div className='__wrapper'>
            ...
            <div className='mt-10 cards'>
                <div className='flex w-full box__wrapper mobiles:block'>
                    <div className='w-1/4 h-[142px] mobiles:w-full mobiles:my-4 mr-5 rounded-[10px] border border-gray-200 p-6'>
                        ...
                        <p className='text-sm my-1.5'>
                            {paymentList?.length
                                ? paymentList[0]?.dateYear
                                : "N/A"}
                        </p>
                        {/* <p className="text-sm my-1.5">{paymentList?.length ? paymentList[0]?.dateYear : 'N/A'}</p> */}
                        <h2 className='text-[28px] font-bold flex justify-between items-center'>
                    ...
                    <div className='w-1/4 h-[142px] mobiles:w-full mobiles:my-4 mr-5 rounded-[10px] border border-gray-200 p-6'>
                        ...
                        <p className='text-[28px] font-bold flex justify-between items-center mt-8'>
                            {salaryDate || "N/A"}
                        </p>
                    </div>
                </div>

                <div className='my-auto mt-16 mb-3 text-xl font-semibold text-black capitalize mobiles:hidden'>
                    Withdrawal Payments
                </div>
                <div className='my-8 employee-table'>
