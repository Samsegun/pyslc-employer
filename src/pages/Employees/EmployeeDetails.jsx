...
const EmployeeDetails = () => {
    ...
    useEffect(() => {
        const getCheckInTime = async userId => {
            try {
                ...
                const resetData = res.data.payload.data?.map(
                    (resData, index) => {
                        return {
                            key: index,
                            date: new Date(
                                resData.clock_in_time
                            ).toLocaleDateString(),
                            timeIn: new Date(
                                resData.clock_in_time
                            ).toLocaleTimeString(),
    ...
    return (
        <div className='-mt-2 pb-16'>
            ...
            <div className='text-xl text-black font-semibold mt-10'>
                Employee Details{" "}
            </div>
            {/* <div className='bg-[#F9F9F9] flex flex-wrap items-center mobiles:w-full px-[34px] py-3 mt-8 max-w-[807px] rounded-[5px] h-[50px]'> */}
            <div className='bg-[#F9F9F9] flex flex-wrap mobiles:gap-[2rem] items-center justify-center mobiles:w-full px-[34px] py-3 mt-8 max-w-[807px] rounded-[5px]'>
            ...
            <div className='mt-12'>
                <div className='mobiles:border-0 border border-gray-200 rounded-md'>
                    <div className='flex py-6 px-[37px] justify-between border-b-2'>
                        <div className='col-1 text-xl font-semibold'>
                            Employee Details
                        </div>
                    ...
                    {fetchingEmpData ? (
                        ...
                        <div className='content w-full flex mobiles:block'>
                            ...
                            <div className='w-1/3 py-7 mobiles:px-[60px] mobiles:w-full'>
                                <EmployeeInfo
                                    title='Bank Name'
                                ...
                                <EmployeeInfo
                                    title='Account Name'
                                    value={
                                        employeeData?.bankDetails.account_name
                                    }
                                />
                                <EmployeeInfo
                                    title='Account Number'
                                    value={
                                        employeeData?.bankDetails.account_number
                                    }
                                />
                            </div>
                            <div className='w-1/3 py-7 mobiles:px-[60px] mobiles:w-full'>
                    ...
                    <div className='my-5 px-[60px]'>
                        <div className='flex w-[209px] bg-gray-100 rounded-[5px] overflow-hidden'>
                            <div
                                className={`px-6 py-3 ${
                                    activeTab === 0
                                        ? " bg-blue-600 rounded-[5px] text-white"
                                        : "bg-gray-100"
